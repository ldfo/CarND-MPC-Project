...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
	...
	double cte = state[4]; // cte

	double epsi = state[5]; // steering angle error
  ...
  // posX, posyY, orientation, velocity
	int dim_state_vector = 4;  
	
  // steering angle, acceleration
  int dim_actuator_vector = 2;
	int n_timesteps = 6; 
